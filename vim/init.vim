...
augroup large_file_performance
  autocmd!
  autocmd BufReadPost * if getfsize(expand('%')) > 512 * 1024
    \| syntax off
    \| setlocal filetype=
    \| setlocal nonumber
...
augroup load_sensible
  autocmd!
  autocmd BufReadPost * call plug#load('vim-sensible')
    \| autocmd! load_sensible
augroup END
...
augroup load_textobj
  autocmd!
  autocmd BufReadPost * call plug#load('vim-textobj-user', 'vim-textobj-indent', 'vim-textobj-line', 'vim-textobj-comment', 'targets.vim')
